...
\begin{The}[Банаха об обратном оператора]\label{Banahobr}
...
\begin{The}[о гомоморфизме]\label{ogom}
...
\begin{The}[о тройке]\label{otroike}
...
\begin{Lem}[о бианнуляторе]\label{bianu}
